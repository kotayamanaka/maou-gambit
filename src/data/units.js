...
export const allyTemplates = {
  ...
  boneGuard: {
    ...
    type: 'ally',
    role: 'guard',
    sprite: 'assets/sprites/boneGuard/idle-front.png',
    spriteSet: spriteSetFor('boneGuard'),
  ...
  impArcher: {
    ...
    type: 'ally',
    role: 'ranged',
    sprite: 'assets/sprites/impArcher/idle-front.png',
    spriteSet: spriteSetFor('impArcher'),
  ...
  oracleShade: {
    ...
    type: 'ally',
    role: 'tactician',
    sprite: 'assets/sprites/oracleShade/idle-front.png',
    spriteSet: spriteSetFor('oracleShade'),
...
export const enemyTemplates = {
  ...
  guard: {
    ...
    name: '盾兵',
    type: 'enemy',
    sprite: 'assets/sprites/guard/idle-front.png',
    spriteSet: spriteSetFor('guard'),
  ...
  ranger: {
    ...
    name: '弓兵',
    type: 'enemy',
    sprite: 'assets/sprites/ranger/idle-front.png',
    spriteSet: spriteSetFor('ranger'),
  ...
  cleric: {
    ...
    name: '僧侶',
    type: 'enemy',
    sprite: 'assets/sprites/cleric/idle-front.png',
    spriteSet: spriteSetFor('cleric'),
  ...
  knight: {
    ...
    name: '騎士',
    type: 'enemy',
    sprite: 'assets/sprites/knight/idle-front.png',
    spriteSet: spriteSetFor('knight'),
  ...
  alchemist: {
    ...
    name: '錬金術師',
    type: 'enemy',
    sprite: 'assets/sprites/alchemist/idle-front.png',
    spriteSet: spriteSetFor('alchemist'),
  ...
  beastTamer: {
    ...
    name: '獣使い',
    type: 'enemy',
    sprite: 'assets/sprites/beastTamer/idle-front.png',
    spriteSet: spriteSetFor('beastTamer'),
  ...
  paladin: {
    ...
    name: '聖騎士',
    type: 'enemy',
    sprite: 'assets/sprites/paladin/idle-front.png',
    spriteSet: spriteSetFor('paladin'),
  ...
  hero: {
    ...
    name: '勇者',
    type: 'enemy',
    sprite: 'assets/sprites/hero/idle-front.png',
    spriteSet: spriteSetFor('hero'),
