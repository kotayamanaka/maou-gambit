...
- `npm run build:pages`
- `npm run test:smoke -- --reporter=list --workers=1`
- `npm run test:balance`

Latest balance check:

- Raw stage win rate: 2/3
- Campaign check: victory
- Campaign final lord damage: 0
- Stage 3 tuning: enemy count preserved, spawn delays widened to make the defense line readable.
